...
This capability covers metadata and cover image extraction from CBZ (Comic Book ZIP) archives, and their integration into the shared file metadata extraction pipeline.
